...
namespace IxSApp
{
    ...
    /// 
    /// </summary>
    public sealed class BewerbungDataUnit : IWorkDataUnit
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BewerbungDataUnit"/> class.
        /// </summary>
        public BewerbungDataUnit()
        {

        }

        #region BewerbungDataUnit (IDataUnit)
        ...
        /// The table.
        /// </value>
        public string Table { get { return "ASXS_BEWERBUNG"; } }
        ...
        public QueryStateType Insert(Units units, long id = 0)
        {
            ...
            try
            {
                ...
                (
                    ...
                    {
                        Command = Command,
                        CommandText = units.Bewerbung.ToSqlString(StatementType.Insert, units, id),
                        Compile = true,
                        MakeAsync = false
                    }
                );
        ...
        public QueryStateType Update(Units units, long id = 0)
        {
            ...
            try
            {
                ...
                (
                    ...
                    {
                        Command = Command,
                        CommandText = units.Bewerbung.ToSqlString(StatementType.Update, units, id),
                        Compile = true,
                        MakeAsync = false
                    }
                );
